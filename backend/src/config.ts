...
const requiredSettings = process.env.UPLOADER_TYPE === 'local'
  ? []
  : [
    'GCP_DEFAULT_REGION',
    'GCP_MISC_BUCKET',
...
export default {
  ...
  meetingSilenceThreshold: process.env.MEETING_SILENCE_THRESHOLD ? Number(process.env.MEETING_SILENCE_THRESHOLD) : 1,
  participantInactivityEnabled: process.env.MEETING_PARTICIPANT_INACTIVITY_ENABLED === 'true',
